...
# Diferentes tipos de datos se almacenan de diferente manera en la memoria del computador, no pueden mezclarse (mentira, si se puede, dero con unos trucos...)

# Pasos para trabajar con variables
# a-se declaran...
# b-se les asigna un valor...
# c-se usan...
...
print texto, resultado # "concatenar" texto y el resultado en un alinea




"""
#2 a veces es necesario convertir datos de un tipo a otro 
...
"""
#3 Concatenay v/s sumar (u otra operación)
#print 2 + 2 # entre numerros, el + suma
